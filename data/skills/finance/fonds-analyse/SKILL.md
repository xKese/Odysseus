...
1. Frage nach gewuenschter Ausfuehrlichkeitsstufe: (1) Kurzuebersicht fuer Kundenkommunikation, (2) Detailanalyse intern, (3) Vergleichstabelle fuer mehrere Fonds. Falls die Quellen-PDFs noch fehlen, frage nach Upload oder ISIN.
2. Lies alle bereitgestellten Factsheets/Dokumente und extrahiere die Pflichtfelder gemaess Kennzahlentabelle im body_extra (Stammdaten, Performance, Risiko, Portfolio). Verwende `read_file` fuer hochgeladene Dateien und `web_fetch` nur fuer oeffentliche Anbieter-Seiten.
